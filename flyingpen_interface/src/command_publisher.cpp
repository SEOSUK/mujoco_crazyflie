...
public:
  ...
  : Node("command_publisher")
  {
    ...
    pos_delta_[0] = this->declare_parameter<double>("dx", 0.05);
    pos_delta_[1] = this->declare_parameter<double>("dy", 0.05);
    pos_delta_[2] = this->declare_parameter<double>("dz", 0.05);
